...
def main():
    try:
        ...
        # an invalid integer for the line number.
        print()
        print(type(csv_err).__name__, csv_err, sep=": ")
        print("You entered an invalid csv file. Maybe it is" \
                  "not in the right format.")
        print("Run the program again and enter a valid csv file.")

    except ZeroDivisionError as zero_division_err:
        # This code will be executed if the user enters
        # an invalid integer for the line number.
        print()
        print(type(zero_division_err).__name__, zero_division_err, sep=": ")
        print("One of the rows in the CSV file contains zero (0) in the 'Fatal Crashes' column.")
        print("Run the program again and enter a valid csv file.")
